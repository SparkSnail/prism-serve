...
The campaign producer and validator are maintained in the companion [`prism-family` benchmark tools](https://github.com/SparkSnail/prism-family/tree/main/benchmarks). The public evidence record includes the model revision, source commits, image digests, topology, workload, aggregation percentiles, and route counters needed to interpret the headline numbers.
